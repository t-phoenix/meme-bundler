...
async function main(){
    ...
    const priceLower = 0.0005;
    const priceUpper = 10;


    // INPUTS
    const freyaInput = hre.ethers.parseUnits('636000', 'ether'); // 2000/1 or 0.0005
    const usdcInput = hre.ethers.parseUnits('40', 6);
    ...
    await printBalances(uniswapAddresses.freyaUsdcPoolAddress)
